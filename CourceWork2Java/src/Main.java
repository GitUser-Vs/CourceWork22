...
public class Main {
    ...
    public static void main(String[] args) {
        // Инициализация (автоматически загружает данные)
        ...
        try {
            ...
            if (activeRole == Role.ADMIN) {
                switch (choice) {
                    ...
                    case 11: library.addBook(true); break; // Добавление цифровой книги
                ...
                switch (choice) {
                    ...
                    case 5: library.viewMyBooks(); break; // Вызов новой функции
                    case 0: library.saveAllData(); System.exit(0);
                    default: System.out.println("Неверный пункт меню.");
                }
            }
...
//        // Вызов перегруженного метода, который вызывает метод родителя
//        student.printDetails("Student Call");
//        // Вызов перегруженного метода, который НЕ вызывает метод родителя явно
...
//    }
//    
//    public static void demonstrateAdvancedFeatures(Library library, Book bookA, StudentUser student1, FacultyUser faculty1) {
//        System.out.println("\n--- Demonstrating Advanced OOP (Generics, Collections, Algorithms) ---");
//        
//        // 1) Демонстрация сортировки и поиска (используя Streams)
//        System.out.println("\n--- 1. Sorting and Searching (Streams) ---");
//        List<Book> sortedBooks = library.getAllBooksSortedByTitle();
//        System.out.println("Books sorted by title:");
//        sortedBooks.forEach(b -> System.out.println("  " + b.getTitle()));
//        
//        List<User> borrowers = library.findUsersWithBorrowedBooks();
//        System.out.println("Users currently borrowing: " + borrowers.size());
//        
//        // 3) Демонстрация шаблонного класса LibraryCatalog
//        LibraryCatalog<Book> bookCatalog = new LibraryCatalog<>("Fiction Catalog");
//        bookCatalog.addItem(bookA);
//        bookCatalog.addItem(new Book("Dune", "Frank Herbert", 4));
//        
//        LibraryCatalog<StudentUser> studentCatalog = new LibraryCatalog<>("Student Roster");
//        studentCatalog.addItem(student1);
//        
//        bookCatalog.printAllItemDetails();
//        
//        // Демонстрация шаблонной функции с ограничениями
//        List<Renewable> renewableItems = List.of(bookA, student1, faculty1); // Создаем список, элементы которого реализуют Renewable
//        
//        // Чтобы передать в функцию, нам нужен List<T extends Renewable>
//        List<LocalDate> renewalDates = Utility.calculateRenewalDates(
//            List.of(bookA, student1, faculty1), 
//            10 // Продление на 10 дней
//        );
//        System.out.println("Calculated renewal dates: " + renewalDates);
//    }
//    
//// Main
//    public static void main(String[] args) {
